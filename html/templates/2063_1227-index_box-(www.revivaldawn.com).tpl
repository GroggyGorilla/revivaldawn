...
<!-- BEGIN catrow -->
	...
	<!-- BEGIN forumrow -->
				<li class="row">
					<dl class="icon row" style="background:url({catrow.forumrow.FORUM_FOLDER_IMG}) no-repeat scroll {catrow.forumrow.INC_LEVEL} 50%;">
						<dd class="dterm col-md-8 my-auto">
						...
						<dd class="lastpost col-md-4 my-auto">
							<div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <!-- BEGIN avatar -->
                                            <span class="lastpost-avatar">{catrow.forumrow.avatar.LAST_POST_AVATAR}</span><br /><br />
                                            <!-- END avatar -->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br />
                            <h4><span class="topics badge bg-dark">{catrow.forumrow.TOPICS} <dfn>{L_TOPICS}</dfn> <i class="ion-android-list" data-tooltip="{L_TOPICS}"></i></span>&nbsp;&nbsp;
                            <span class="posts badge bg-dark">{catrow.forumrow.POSTS} <dfn>{L_POSTS}</dfn> <i class="ion-android-chat" data-tooltip="{L_POSTS}"></i></span></h4>
						</dd>
					</dl>
				</li>
	<!-- END forumrow -->
