...
<!-- Discord Button -->
<a id="lnk-discord-join" href="https://discord.gg/G8KgdmZ" data-tooltip="Join Our Discord Server" target="_blank">
    <img id="img-discord-join" src="https://i.servimg.com/u/f60/18/75/26/17/discor10.png" alt="Join Revival Dawn on Discord" />
</a>
<!-- Modal Image Overlay -->
...
<!-- Assessment modal -->
<div class="modal fade" tabindex="-1" id="assessment-modal">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content bg-dark">
      ...
      <div class="modal-body">
		<blockquote>...<span id="assessment-quote-selected"></span>...</blockquote>
        <p id="assessment-comment-selected"></p>
      </div>
    </div>
  </div>
</div>
