$(function () { 
    ...
    var tooltipText = [
        ...
        '<strong>Tier 4 Equipment</strong><br />+20 ATK<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 ATK<br /><em>(Devil Fruit Fed)</em>',
        ...
        '<strong>Tier 4 Equipment</strong><br />+20 ATK<br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 ATK<br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 ATK<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 ATK<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 ATK<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 ATK<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        ...
        '<strong>Tier 4 Equipment</strong><br />+20 DEF<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 DEF<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 DEF<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 DEF<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 DEF<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 DEF<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 1 Equipment</strong><br />+5 DEF<br /><em>(Broken)</em>',
        '<strong>Tier 2 Equipment</strong><br />+10 DEF<br /><em>(Broken)</em>',
        '<strong>Tier 3 Equipment</strong><br />+15 DEF<br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 DEF<br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 DEF<br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 DEF<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 DEF<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 DEF<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 DEF<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        ...
        '<strong>Tier 4 Equipment</strong><br />+20 RX<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 RX<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 RX<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 RX<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 RX<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 RX<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 1 Equipment</strong><br />+5 RX<br /><em>(Broken)</em>',
        '<strong>Tier 2 Equipment</strong><br />+10 RX<br /><em>(Broken)</em>',
        '<strong>Tier 3 Equipment</strong><br />+15 RX<br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 RX<br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 RX<br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 RX<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 RX<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 RX<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 RX<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        ...
        '<strong>Tier 4 Equipment</strong><br />+20 WP<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 WP<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 WP<br /><em>(Devil Fruit Fed)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 WP<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 WP<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 WP<br /><em>(Sea Prism Stone Tipped)</em>',
        '<strong>Tier 1 Equipment</strong><br />+5 WP<br /><em>(Broken)</em>',
        '<strong>Tier 2 Equipment</strong><br />+10 WP<br /><em>(Broken)</em>',
        '<strong>Tier 3 Equipment</strong><br />+15 WP<br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 WP<br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 WP<br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 WP<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 WP<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 4 Equipment</strong><br />+20 WP<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 5 Equipment</strong><br />+30 WP<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 ATK<br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 ATK<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 ATK<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 DEF<br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 DEF<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 DEF<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 RX<br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 RX<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 RX<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 WP<br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 WP<br /><em>(Sea Prism Stone Tipped)</em><br /><em>(Broken)</em>',
        '<strong>Tier 6 Equipment</strong><br />+50 WP<br /><em>(Devil Fruit Fed)</em><br /><em>(Broken)</em>',
