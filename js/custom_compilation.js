$(function () { 
    ...
    var tooltipText = [
        ...
        '<strong>Wind Caller:</strong> +25% Sails for 2 rounds',
        '<strong>Barrel Crazed:</strong> +25% Cannons for 2 rounds',
        '<strong>Hammerhanded:</strong> One equipment repair per thread',
        '<strong>Master Chef:</strong> Up to 3 allies can start combat with 110% HP',
        '<strong>Dulcet Virtuoso:</strong> +10% to ATK or RX for 3 allies for 3 rounds',
        '<strong>Nautical Almanac:</strong> +2 to ship combat escape roll value',
        '<strong>Walking, Talking First Aid Kit:</strong> Revive and UT Heals',
        '<strong>Ship Bringer:</strong> One ship repair per thread',
        '<strong>Punchout Guru:</strong> +0.20 EXP Bonus to all allies in a quest',
        '<strong>Berry Printer:</strong> +0.20 Income Bonus to all allies in a quest',
        '<strong>Hard-boiled:</strong> +15 stats',
        '<strong>Child of Destiny:</strong> +25 stats',
        '<strong>Dreams Never Die:</strong> Resist knockout once per thread',
        '<strong>Freak of Nature:</strong> Stat buffs at low health',
        '<strong>Jurassic Bark:</strong> Ancient zoan eater',
        '<strong>Untouchable:</strong> Logia user',
        '<strong>Dragonheart:</strong> Mythical zoan eater',
        '<strong>Bookworm:</strong> Poneglyph literate',
        '<strong>Bane of the Weak:</strong> Haoshoku user',
        '<strong>Devil&#8217;s Advocate:</strong> +100 stats',
        '<strong>Strolling Death:</strong> +200 stats',
        '<strong>The Chosen One:</strong> Inherited the Will of D',
        '<strong>Rise and Shine:</strong> Awakening/Mastery Unlocked',
        '<strong>Haki Specialization:</strong> Kenbunshoku',
        '<strong>Haki Specialization:</strong> Busoshoku',
        '<strong>Haki Specialization:</strong> Haoshoku',
        '<strong>Haki Ascendancy:</strong> Kenbunshoku',
        '<strong>Haki Ascendancy:</strong> Busoshoku',
        '<strong>Haki Ascendancy:</strong> Haoshoku',
        '<strong>One-Needle Log Pose:</strong> Travel across Paradise',
        '<strong>Three-Needle Log Pose:</strong> Travel across the New World',
        'Mythical Zoan Fruit',
        'Logia Fruit',
        'Ancient Zoan Fruit',
        '<strong>Steel Bracing:</strong> +25% Hull for 2 rounds',
        '<strong>Cola Engine:</strong> +25% Sails for 2 rounds',
        '<strong>Chain Cannons:</strong> +25% Cannons for 2 rounds',
        '<strong>Sea Prism Stone Keel:</strong> Sail through Calm Belt',
        '<strong>Submarine (Toggle):</strong> +25% Sails, -25% Cannons',
        '<strong>Blimp (Toggle):</strong> +25% Cannons, -25% Hull',
        '<strong>Treasure Tree Adam Wood:</strong> +200 Hull',
        '<strong>Tier 1 Equipment:</strong> +5 ATK',
        '<strong>Tier 2 Equipment:</strong> +10 ATK',
        '<strong>Tier 3 Equipment:</strong> +15 ATK',
        '<strong>Tier 4 Equipment:</strong> +20 ATK',
        '<strong>Tier 5 Equipment:</strong> +30 ATK',
        '<strong>Tier 6 Equipment:</strong> +50 ATK',
        '<strong>Tier 4 Equipment:</strong> +20 ATK (Devil Fruit Fed)',
        '<strong>Tier 5 Equipment:</strong> +30 ATK (Devil Fruit Fed)',
        '<strong>Tier 6 Equipment:</strong> +50 ATK (Devil Fruit Fed)',
        '<strong>Tier 4 Equipment:</strong> +20 ATK (Sea Prism Stone Tipped)',
        '<strong>Tier 5 Equipment:</strong> +30 ATK (Sea Prism Stone Tipped)',
        '<strong>Tier 6 Equipment:</strong> +50 ATK (Sea Prism Stone Tipped)',
        '<strong>Tier 1 Equipment:</strong> +5 ATK (Broken)',
        '<strong>Tier 2 Equipment:</strong> +10 ATK (Broken)',
        '<strong>Tier 3 Equipment:</strong> +15 ATK (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 ATK (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 ATK (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 ATK (Devil Fruit Fed) (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 ATK (Devil Fruit Fed) (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 ATK (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 ATK (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 1 Equipment:</strong> +5 DEF',
        '<strong>Tier 2 Equipment:</strong> +10 DEF',
        '<strong>Tier 3 Equipment:</strong> +15 DEF',
        '<strong>Tier 4 Equipment:</strong> +20 DEF',
        '<strong>Tier 5 Equipment:</strong> +30 DEF',
        '<strong>Tier 6 Equipment:</strong> +50 DEF',
        '<strong>Tier 4 Equipment:</strong> +20 DEF (Devil Fruit Fed)',
        '<strong>Tier 5 Equipment:</strong> +30 DEF (Devil Fruit Fed)',
        '<strong>Tier 6 Equipment:</strong> +50 DEF (Devil Fruit Fed)',
        '<strong>Tier 4 Equipment:</strong> +20 DEF (Sea Prism Stone Tipped)',
        '<strong>Tier 5 Equipment:</strong> +30 DEF (Sea Prism Stone Tipped)',
        '<strong>Tier 6 Equipment:</strong> +50 DEF (Sea Prism Stone Tipped)',
        '<strong>Tier 1 Equipment:</strong> +5 DEF (Broken)',
        '<strong>Tier 2 Equipment:</strong> +10 DEF (Broken)',
        '<strong>Tier 3 Equipment:</strong> +15 DEF (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 DEF (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 DEF (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 DEF (Devil Fruit Fed) (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 DEF (Devil Fruit Fed) (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 DEF (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 DEF (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 1 Equipment:</strong> +5 RX',
        '<strong>Tier 2 Equipment:</strong> +10 RX',
        '<strong>Tier 3 Equipment:</strong> +15 RX',
        '<strong>Tier 4 Equipment:</strong> +20 RX',
        '<strong>Tier 5 Equipment:</strong> +30 RX',
        '<strong>Tier 6 Equipment:</strong> +50 RX',
        '<strong>Tier 4 Equipment:</strong> +20 RX (Devil Fruit Fed)',
        '<strong>Tier 5 Equipment:</strong> +30 RX (Devil Fruit Fed)',
        '<strong>Tier 6 Equipment:</strong> +50 RX (Devil Fruit Fed)',
        '<strong>Tier 4 Equipment:</strong> +20 RX (Sea Prism Stone Tipped)',
        '<strong>Tier 5 Equipment:</strong> +30 RX (Sea Prism Stone Tipped)',
        '<strong>Tier 6 Equipment:</strong> +50 RX (Sea Prism Stone Tipped)',
        '<strong>Tier 1 Equipment:</strong> +5 RX (Broken)',
        '<strong>Tier 2 Equipment:</strong> +10 RX (Broken)',
        '<strong>Tier 3 Equipment:</strong> +15 RX (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 RX (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 RX (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 RX (Devil Fruit Fed) (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 RX (Devil Fruit Fed) (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 RX (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 RX (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 1 Equipment:</strong> +5 WP',
        '<strong>Tier 2 Equipment:</strong> +10 WP',
        '<strong>Tier 3 Equipment:</strong> +15 WP',
        '<strong>Tier 4 Equipment:</strong> +20 WP',
        '<strong>Tier 5 Equipment:</strong> +30 WP',
        '<strong>Tier 6 Equipment:</strong> +50 WP',
        '<strong>Tier 4 Equipment:</strong> +20 WP (Devil Fruit Fed)',
        '<strong>Tier 5 Equipment:</strong> +30 WP (Devil Fruit Fed)',
        '<strong>Tier 6 Equipment:</strong> +50 WP (Devil Fruit Fed)',
        '<strong>Tier 4 Equipment:</strong> +20 WP (Sea Prism Stone Tipped)',
        '<strong>Tier 5 Equipment:</strong> +30 WP (Sea Prism Stone Tipped)',
        '<strong>Tier 6 Equipment:</strong> +50 WP (Sea Prism Stone Tipped)',
        '<strong>Tier 1 Equipment:</strong> +5 WP (Broken)',
        '<strong>Tier 2 Equipment:</strong> +10 WP (Broken)',
        '<strong>Tier 3 Equipment:</strong> +15 WP (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 WP (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 WP (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 WP (Devil Fruit Fed) (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 WP (Devil Fruit Fed) (Broken)',
        '<strong>Tier 4 Equipment:</strong> +20 WP (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 5 Equipment:</strong> +30 WP (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 ATK (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 ATK (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 ATK (Devil Fruit Fed) (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 DEF (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 DEF (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 DEF (Devil Fruit Fed) (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 RX (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 RX (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 RX (Devil Fruit Fed) (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 WP (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 WP (Sea Prism Stone Tipped) (Broken)',
        '<strong>Tier 6 Equipment:</strong> +50 WP (Devil Fruit Fed) (Broken)',
        '<strong>Screw You, RNGesus:</strong> Do a combat re-roll',
        '<strong>Tactical Retreat:</strong> Escape without a roll',
        '<strong>Under The Radar:</strong> Freeze bounty',
        '<strong>Identity Theft:</strong> Counter information metagame',
        '<strong>Social Distancing:</strong> Reduce quest player requirement',
        '<strong>Land Crawler (Toggle):</strong> +25% Hull, -25% Sails',
      	'<strong>Skin Of Your Teeth:</strong> Downgrade first crit to solid hit',
      	'<strong>Freedom Of Travel:</strong> Bypass sea restrictions for a new quest'
    ];
